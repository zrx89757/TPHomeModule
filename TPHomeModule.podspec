...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/chris.zhong/TPHomeModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'chris.zhong' => 'rongxing.zhong@patpat.com' }
  s.source           = { :git => 'https://github.com/chris.zhong/TPHomeModule.git', :tag => s.version.to_s }
